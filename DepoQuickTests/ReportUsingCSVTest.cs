...
[TestClass]
public class ReportUsingCSVTest
{
        ...
        private ReportUsingCSV _reportUsingCsv; 
    ...
    public void TestInitialize()
    {
        ...
        _reportUsingCsv = new ReportUsingCSV(_reservationController, _paymentController); 
    ...
    public void TestCreateReportUsingCSV()
    {
        ...
        String report = _reportUsingCsv.GenerateReport();
        ...
        String paymentStatus = "reservado"; 
